...
export default function Navbar() {
    ...
    return (
        <>
                ...
                <nav className="max-w-7xl mx-auto flex items-center justify-between bg-slate-900/80 backdrop-blur-xl border border-slate-800/80 rounded-full px-5 py-3 shadow-2xl shadow-indigo-950/20">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="hidden md:flex items-center gap-5">
                            <Link to="/features/ats-check" className="text-sm font-medium text-slate-400 hover:text-white transition">
                                ATS Checker
                            </Link>
                            <Link to="/features/cover-letter" className="text-sm font-medium text-slate-400 hover:text-white transition">
                                Cover Letter
                            </Link>
            ...
            <div className={`fixed inset-0 bg-slate-950/90 backdrop-blur-2xl z-50 flex flex-col justify-between transition-all duration-300 md:hidden p-6 ${mobileOpen ? 'opacity-100 pointer-events-auto translate-y-0' : 'opacity-0 pointer-events-none -translate-y-4'}`}>
                ...
                <div className="flex items-center justify-between w-full">
                    ...
                    <button 
                        ...
                        className="text-slate-400 hover:text-white p-2.5 rounded-xl bg-slate-900 border border-slate-800 cursor-pointer"
                ...
                {/* Drawer Links Body */}
                <div className="flex flex-col gap-2.5 w-full max-w-xs mx-auto text-left">
                    <button onClick={() => { window.scrollTo({ top: 0, behavior: 'smooth' }); setMobileOpen(false); }} className="w-full px-4 py-2.5 rounded-xl bg-slate-900/60 border border-slate-800 text-slate-200 font-medium text-sm flex items-center justify-between hover:bg-slate-900 transition">
                        <span>Home</span>
                    ...
                    <Link to="/features/ats-check" onClick={() => setMobileOpen(false)} className="w-full px-4 py-2.5 rounded-xl bg-slate-900/60 border border-slate-800 text-slate-200 font-medium text-sm flex items-center justify-between hover:bg-slate-900 transition">
                        <span>ATS Checker</span>
                        <svg className="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"/></svg>
                    </Link>

                    <Link to="/features/cover-letter" onClick={() => setMobileOpen(false)} className="w-full px-4 py-2.5 rounded-xl bg-slate-900/60 border border-slate-800 text-slate-200 font-medium text-sm flex items-center justify-between hover:bg-slate-900 transition">
                        <span>Cover Letter</span>
                        <svg className="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"/></svg>
                    </Link>

                    <button onClick={() => scrollToSection('features')} className="w-full px-4 py-2.5 rounded-xl bg-slate-900/60 border border-slate-800 text-slate-200 font-medium text-sm flex items-center justify-between hover:bg-slate-900 transition">
                        <span>About</span>
                        <svg className="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"/></svg>
                    </button>

                    <button onClick={() => scrollToSection('testimonials')} className="w-full px-4 py-2.5 rounded-xl bg-slate-900/60 border border-slate-800 text-slate-200 font-medium text-sm flex items-center justify-between hover:bg-slate-900 transition">
                ...
                <div className="w-full max-w-xs mx-auto pb-4">
                    {isSignedIn ? (
                        <div className="flex flex-col gap-3 w-full">
                            <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-slate-900 border border-slate-800 w-full">
                            ...
                            <Link to="/app" onClick={() => setMobileOpen(false)} className="w-full py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-medium text-sm text-center shadow-lg shadow-indigo-600/30 transition">
                                Dashboard
                            </Link>
                        ...
                        <div className="flex flex-col gap-3 w-full">
                            ...
                            <Link to="/login" onClick={() => setMobileOpen(false)} className="w-full py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-medium text-sm text-center shadow-lg shadow-indigo-600/30 transition">
                                Sign In
                            </Link>
                        </div>
                    )}
